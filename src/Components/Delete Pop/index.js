...
const BootstrapDialogs = styled(Dialog)(({ theme }) => ({
 ...
 function DeletePop(props) {
    ...
    function deleteMarker(){
        axios({
            method: "DELETE",
            url: `http://18.222.221.0:1337/markers/${deleteId}`,
            headers: { 
        ...
        >
          <DialogContent dividers style={{width:480,height:100,overflowX:'hidden',overflowY:"hidden"}}>
            ...
            <div className="btn-pop-cont">
                ...
                {response==null?<button className="ad-btn" onClick={()=>{navigateAddPage();deleteMarker();setClick(true)}}>Confirm</button>:null}
